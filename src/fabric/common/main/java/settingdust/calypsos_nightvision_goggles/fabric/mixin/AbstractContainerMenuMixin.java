...
import settingdust.calypsos_nightvision_goggles.fabric.util.ItemStackedOnOtherCallback;
...
public class AbstractContainerMenuMixin {
    ...
    private boolean calypsos_nightvision_goggles$checkForgeItemStackedEvent(
