...
import settingdust.calypsos_nightvision_goggles.effect.ClockworkFocusMobEffect
...
object CalypsosNightVisionGogglesMobEffects {
    ...
    fun registerMobEffects(register: (ResourceLocation, MobEffect) -> Unit) {
        ...
        register(CalypsosNightVisionGogglesKeys.ClockworkFocus, ClockworkFocusMobEffect)
    }
}