...
interface CalypsosNightVisionGogglesItems {
    ...
    fun registerItems(register: (ResourceLocation, Item) -> Unit) {
        ...
        register(CalypsosNightVisionGogglesKeys.PURIFIER_GOGGLES, factory(RegularVariant))
        register(CalypsosNightVisionGogglesKeys.NIGHT_OWL_GOGGLES, factory(RegularVariant))
    }
}